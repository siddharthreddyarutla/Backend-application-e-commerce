...
public class ProductController {
  ...
  private ResponseEntity<ProductDto> editDetailsById(@RequestParam Long productId,
      @RequestBody ProductDto productDto) {
    return new ResponseEntity<>(productServiceImpl.editDetailsById(productId, productDto),
        HttpStatus.OK);
  }
  ...
  private ResponseEntity<List<ProductDto>> getProductByCategory(@RequestParam String category) {
    return new ResponseEntity<>(productServiceImpl.searchProductByCategory(category),
        HttpStatus.OK);
  }
  ...
  private ResponseEntity<List<ProductDto>> filterByPrice(
      @RequestParam(required = false) Long leastPrice,
    ...
    if (leastPrice != null && highestPrice == null) {
      ...
      return new ResponseEntity<>(productServiceImpl.searchByHighestPrice(highestPrice),
          HttpStatus.OK);
    } else {
      return new ResponseEntity<>(
          productServiceImpl.searchByLeastPriceAndHighestPrice(leastPrice, highestPrice),
          HttpStatus.OK);
    }
  }
  ...
  private ResponseEntity<ProductCompleteDetailsDto> postProductCompleteDetails(
      @RequestBody ProductCompleteDetailsDto productCompleteDetails) {
    return new ResponseEntity<>(
        productServiceImpl.postCompleteDetailsOfProduct(productCompleteDetails), HttpStatus.OK);
  }
  ...
  private ResponseEntity<ProductCompleteDetailsDto> getCompleteProductDetailById(
      @PathVariable Long productId) {
    return new ResponseEntity<>(productServiceImpl.getCompleteProductDetailsByProductId(productId),
        HttpStatus.OK);
  }

  // put all complete product details by ProductId
  @PutMapping(value = "/editCompleteProductDetailsByProductId")
  private ResponseEntity<ProductCompleteDetailsDto> editCompleteProductDetailsById(
  ...
  // if quantity becomes 0 automatically it will be set as OUT OF STOCK but for any reasons we
  // can edit state or mark it as OUT OF STOCK
  ...
  private ResponseEntity<ProductInfoDto> SetStateAsOutOfStock(@RequestParam Long productId,
    ...
    return new ResponseEntity<>(productServiceImpl.setStateOfProduct(productId, productState),
        HttpStatus.OK);
  }

  @PutMapping(value = "/updateProductQuantityByProductId")
  private ResponseEntity<ProductInfoDto> editProductQuantityByProductId(
      @RequestParam Long productId, @RequestParam Long productQuantity) {
    return new ResponseEntity<>(
        productServiceImpl.putProductQuantityByProductId(productId, productQuantity),
        HttpStatus.OK);
  }
  ...
  private ResponseEntity<String> deleteCompleteProductDetailsByProductId(
      @RequestParam Long productId) {
    return new ResponseEntity<>(
        productServiceImpl.deleteCompleteProductDetailsByProductId(productId), HttpStatus.OK);
  }
